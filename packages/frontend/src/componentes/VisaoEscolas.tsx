          ...
          return (
            ...
            >
              <div>
                ...
                <div className="grid grid-cols-2 gap-2 p-3 bg-slate-50/80 border border-slate-100 rounded-xl mb-4 text-xs">
                  <div>
              ...
              <div className="flex items-center justify-between pt-3 border-t border-slate-100">
                ...
                {!estaAtiva ? (
                  <button
                    ...
                    className="px-3.5 py-1.5 text-xs font-bold text-blue-700 bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-xl transition-all cursor-pointer shadow-2xs active:scale-95"
                  >
