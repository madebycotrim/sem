...
export const ModalNovoPaciente: FC<ModalNovoPacienteProps> = ({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-xs anim-surgir"
      role="dialog"
      aria-modal="true"
    ...
    >
      <div className="bg-white border border-slate-200 rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col anim-surgir">
        {/* Cabeçalho do Modal */}
        ...
        {/* Formulário (Fiel à imagem de referência) */}
        <form onSubmit={handleSubmit(onSubmit)} className="px-6 py-4 space-y-4 text-xs">
          ...
          <div>
            <div className="text-[11px] font-bold text-blue-600 uppercase tracking-wider mb-3 pb-1 border-b border-slate-100">
              DADOS PESSOAIS
            </div>
            ...
            <div className="mb-3.5">
              ...
              <div className="relative">
                <select
                  ...
                  className={`w-full appearance-none px-3 py-2 bg-white border rounded-lg text-xs font-semibold text-slate-800 uppercase focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition-all cursor-pointer ${
              ...
              {errors.instituicao && <p className="text-[10px] text-red-600 mt-0.5">{errors.instituicao.message}</p>}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-3 mb-3.5">
              <div className="md:col-span-6">
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 bg-slate-50/50 border rounded-lg text-xs text-slate-800 uppercase placeholder-slate-400 focus:bg-white focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition-all ${
                    errors.nomeCompleto ? 'border-red-400' : 'border-slate-200'
                  }`}
                />
                {errors.nomeCompleto && (
                  <p className="text-[10px] text-red-600 mt-0.5">{errors.nomeCompleto.message}</p>
                )}
              </div>
              ...
              <div className="md:col-span-3">
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 bg-slate-50/50 border rounded-lg text-xs font-mono text-slate-800 placeholder-slate-400 focus:bg-white focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition-all ${
                    errors.cpf ? 'border-red-400' : 'border-slate-200'
                  }`}
                />
                {errors.cpf && <p className="text-[10px] text-red-600 mt-0.5">{errors.cpf.message}</p>}
              </div>
              ...
              <div className="md:col-span-3">
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 bg-slate-50/50 border rounded-lg text-xs text-slate-800 focus:bg-white focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition-all ${
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
              <div className="md:col-span-4">
                ...
                <div className="relative">
                  <select
                    {...register('sexo')}
                    className={`w-full appearance-none px-3 py-2 bg-slate-50/50 border rounded-lg text-xs text-slate-800 focus:bg-white focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition-all cursor-pointer ${
                ...
                {errors.sexo && <p className="text-[10px] text-red-600 mt-0.5">{errors.sexo.message}</p>}
              </div>
              ...
              <div className="md:col-span-4">
                ...
                />
                {errors.telefone && <p className="text-[10px] text-red-600 mt-0.5">{errors.telefone.message}</p>}
              </div>
              ...
              <div className="md:col-span-4">
                ...
                {errors.perfilUsuario && (
                  <p className="text-[10px] text-red-600 mt-0.5">{errors.perfilUsuario.message}</p>
                )}
              </div>
            </div>
          </div>

          {/* Rodapé de Botões (Cancelar & Cadastrar Paciente) */}
          <div className="flex items-center justify-end gap-2.5 pt-4">
            ...
            <button
              type="submit"
              disabled={salvando}
              className="px-5 py-2 text-xs font-bold text-white bg-blue-600 hover:bg-blue-700 active:bg-blue-800 rounded-lg shadow-xs transition-all active:scale-[0.98] disabled:opacity-50 flex items-center gap-1.5 cursor-pointer"
            >
              {salvando ? (
                <>
