          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-slate-200 bg-slate-50/70 text-[11px] font-bold text-slate-500 uppercase tracking-wider select-none">
                <th scope="col" className="py-3 px-4 font-bold text-slate-600">HORÁRIO</th>
                <th scope="col" className="py-3 px-4 font-bold text-slate-600">ALUNO / PACIENTE</th>
                <th scope="col" className="py-3 px-3 font-bold text-slate-600">ESPECIALIDADE</th>
                <th scope="col" className="py-3 px-3 font-bold text-slate-600">TURNO</th>
                <th scope="col" className="py-3 px-3 font-bold text-slate-600">STATUS DA FILA</th>
                <th scope="col" className="py-3 px-4 font-bold text-slate-600 text-right">CHAMADA & AÇÕES</th>
              </tr>
            </thead>
                      ...
                      <div className="flex items-center justify-end gap-1.5">
                        {item.status === 'AGUARDANDO' && (
                          <button
                            ...
                            className="px-3 py-1.5 text-[11px] font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-lg shadow-2xs transition-all active:scale-95 cursor-pointer"
                          >
                            📢 Chamar & Atender
                          </button>
                        )}
                        {item.status === 'EM_ATENDIMENTO' && (
                          <button
                            ...
                            className="px-3 py-1.5 text-[11px] font-bold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 border border-emerald-300 rounded-lg transition-all active:scale-95 cursor-pointer"
                          >
                            ✓ Concluir
                          </button>
                        )}
