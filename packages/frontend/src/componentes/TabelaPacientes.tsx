...
export const TabelaPacientes: FC<TabelaPacientesProps> = ({
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-xl shadow-2xs overflow-hidden flex flex-col flex-1 min-h-[460px]">
      {/* ─── Tabela de Registros ────────────────────────────────────────── */}
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-slate-200 bg-slate-50/70 text-[11px] font-bold text-slate-500 uppercase tracking-wider select-none">
              <th scope="col" className="py-2.5 px-4 font-bold text-slate-600">
                <div className="flex items-center gap-1 cursor-pointer hover:text-slate-900">
                  <span>PACIENTE</span>
                  <span className="text-[10px] text-slate-400">↑↓</span>
                </div>
              </th>
              <th scope="col" className="py-2.5 px-3 font-bold text-slate-600">
                <div className="flex items-center gap-1">
                  <span>AUTORIZAÇÃO (LGPD)</span>
                </div>
              </th>
              <th scope="col" className="py-2.5 px-3 font-bold text-slate-600">
                <div className="flex items-center gap-1 cursor-pointer hover:text-slate-900">
              ...
              <th scope="col" className="py-2.5 px-4 font-bold text-slate-600 text-right">
                <span>AÇÕES</span>
              </th>
            </tr>
          </thead>
          ...
          <tbody className="divide-y divide-slate-100 text-xs">
            {carregando ? (
              ...
              /* ─── Empty State — Fiel à referência visual do usuário ───── */
              <tr>
                ...
                >
                  ...
                  <td className="py-2.5 px-4 font-semibold text-slate-900">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="group-hover:text-blue-600 transition-colors">{paciente.nome}</span>
                    </div>
                  </td>
                  ...
                  <td className="py-2.5 px-3">
                    <span className="inline-flex items-center justify-center px-2 py-0.5 text-xs font-semibold rounded-full bg-slate-100 text-slate-700">
                      {paciente.atendimentosCount} ficha(s)
                    </span>
                  </td>
                  ...
                  <td className="py-2.5 px-4 text-right">
                    <div className="flex items-center justify-end gap-1.5" onClick={(e) => e.stopPropagation()}>
                      <button
                        ...
                        className="px-2 py-1 text-[11px] font-bold text-blue-700 bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-md transition-all active:scale-95"
