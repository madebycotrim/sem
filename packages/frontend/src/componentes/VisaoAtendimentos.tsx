          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-slate-200 bg-slate-50/70 text-[11px] font-bold text-slate-500 uppercase tracking-wider select-none">
                <th scope="col" className="py-3 px-4 font-bold text-slate-600">PACIENTE</th>
                ...
                <th scope="col" className="py-3 px-3 font-bold text-slate-600">ESCOLA / POLO</th>
                <th scope="col" className="py-3 px-3 font-bold text-slate-600">PROFISSIONAL</th>
                <th scope="col" className="py-3 px-3 font-bold text-slate-600">DATA / HORA</th>
              ...
              {filtrados.length === 0 ? (
                ...
                filtrados.map((item) => (
                  <tr key={item.id} className="hover:bg-slate-50/80 transition-colors">
                    ...
                    <td className="py-3 px-3 text-slate-600 font-medium">{item.escolaNome}</td>
                    <td className="py-3 px-3 text-slate-600">{item.profissionalNome}</td>
